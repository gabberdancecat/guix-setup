(define-module (src home pipewire)
  ...
  #:use-module (gnu home services desktop) ; home-dbus
  #:use-module (guix gexp)
  
  #:export (pipewire-service ; includes home-{dbus,pipewire}
	    home-pipewire-service-type))

;; note: in parent config, add (service home-dbus-service-type)
;; info: https://www.reddit.com/r/GUIX/comments/vpvcld/help_replacing_pulseaudio_with_pipewire_at_system/
;; is this better?: https://github.com/worldofgeese/guix-config/blob/main/worldofguix/services/pipewire.scm
